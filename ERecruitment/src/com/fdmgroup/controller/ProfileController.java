...
public class ProfileController {
  ...
  public String editProfile(Model model, @ModelAttribute User user, ApplicantProfile profile, BindingResult br) {
	...
	public @ResponseBody long createEducation(Model model, @ModelAttribute User user,
		...
		List<Education> educationList = applicantProfile.getEducation();
		if(educationList == null){
			educationList = new ArrayList<>();
		    applicantProfile.setEducation(educationList);
		}
		educationList.add(e);
	...
	public @ResponseBody long createWorkHistory(Model model, @ModelAttribute User user,
		...
		List<WorkHistory> workHistoryList = applicantProfile.getWorkHistory();
		if(workHistoryList == null){
			workHistoryList = new ArrayList<>();
		    applicantProfile.setWorkHistory(workHistoryList);
		}
		workHistoryList.add(wh);

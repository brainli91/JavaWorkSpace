	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				</a> <a class="navbar-brand" href="#home">Trading Platform</a>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><button type="button" class="btn btn-success navbar-btn"  onclick="location.href = 'register.jsp';">
	...
	<div id="myCarousel" class="carousel slide text-center"
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="img/4.jpg" alt="" width="460" height="345">
				<div class="carousel-caption">
					<h4>
						"Canada's Lowest Cost Trading Investor"<br>
						<span style="font-style: normal;">Michael George, The Globe
							and Mail, March 2016</span>
					</h4>
				</div>
			</div>
			<div class="item">
				<img src="img/1.jpg" alt="" width="460" height="345">
				<div class="carousel-caption">
					<h4>
						"One word... Amazing!!"<br>
			...
			<div class="item">
				<img src="img/3.jpg" alt="" width="460" height="345">
				<div class="carousel-caption">
					<h4>
						"Could I bE any more happy with this platform?"<br>
						<span style="font-style: normal;">Nabil Josh, Actor</span>
					</h4>
				</div>
			</div>
	...
	<div id="services" class="container-fluid text-center">
		...
		<div class="row">
			<div class="col-sm-4">
				...
				<br> <img src="img/round1.png"
					class="img-circle person logo-small" alt="Random Name">
			</div>
			<div class="col-sm-4">
				<p>
					<strong>Real-Time Data</strong>
				</p>
				<br> <img src="img/round2.png"
					class="img-circle person logo-small" alt="Random Name">
			</div>
			<div class="col-sm-4">
				<p>
					<strong>Experienced Brokers</strong>
				</p>
				<br> <img src="img/round3.png"
					class="img-circle person logo-small" alt="Random Name">
			</div>
		</div>
		<br /> <br />
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<h4>REAL-TIME QUOTE</h4>
				<p>Most Up to Date Data</p>
			</div>
			<div class="col-sm-4">
		...
		<div class="row">
			<div class="col-sm-4">
				...
				<h4>INVESTMENT</h4>
				<p>Help you to grow</p>
			</div>
			<div class="col-sm-4">
				<span class="glyphicon glyphicon-wrench logo-small"></span>
				<h4>TOOLS</h4>
				<p>Provide most of useful tool set</p>
			</div>
			<div class="col-sm-4">
				<span class="glyphicon glyphicon-certificate logo-small"></span>
				<h4>CERTIFIED</h4>
				<p>Regulated professional individual for both retail and

	...
	<div id="wrapper">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					...
					<li><a href="showusers"><i class="View Users"></i>
							View All Users</a></li>
					<li  class="active"><a href="viewlog"><i
							class="fa fa-fw fa-wrench"></i> View Log</a></li>
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">View All Logs</h1>
						<ol class="breadcrumb">
							<li><i class="fa fa-dashboard"></i> <a
								href="adminindex.jsp">Dashboard</a></li>
							<li class="active"><i class="fa fa-edit"></i>View All Logs</li>
						</ol>
					</div>
				</div>
				<!-- /.row -->

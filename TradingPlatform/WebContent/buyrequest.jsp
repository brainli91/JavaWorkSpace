...
<!-- Navigation -->
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="buyrequest.jsp"><i class="Send Buy Request"></i>
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Send Buy Request</h1>
						<ol class="breadcrumb">
							<li><i class="fa fa-dashboard"></i> <a
								href="shareholderindex.jsp">Dashboard</a></li>
							<li class="active"><i class="fa fa-edit"></i>Send Buy Request</li>
						</ol>
					</div>
				</div>
				<br />
						...
						<div class="col-lg-4 col-lg-offset-4 text-center col-centered">
							...
							<div class="form-group input-group">
								<span class="input-group-addon">Number of Shares</span> <input
									type="text" class="form-control"
									placeholder="Enter Number of Purchasing Shares" name="numshare" required>
							</div>

...
/**
 * Servlet implementation class TwoLogin
 */

public class TwoLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(person == null){
			...
			RequestDispatcher requestDispatcher = request.getRequestDispatcher("TwoRolesLog");
			requestDispatcher.forward(request, response);
		}
	}
